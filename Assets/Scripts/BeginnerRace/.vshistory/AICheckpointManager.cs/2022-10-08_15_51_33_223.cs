...
public class AICheckpointManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        positionSprites = new List<Image>();
    }
    ...
    private void DisplayPlayerPosition()
    {
        ...
        switch (playerPos)
        {
            case 1:
                append = "ST";
                positionImage = positionSprites[0];
                break;
            case 2:
                append = "ND";
                positionImage = positionSprites[1];
                break;
            case 3:
                append = "RD";
                positionImage = positionSprites[2];
                break;
            default:
                append = "TH";
                positionImage = positionSprites[3];
                break;
        }
