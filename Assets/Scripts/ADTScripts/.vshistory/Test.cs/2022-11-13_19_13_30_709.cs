...
public class Test : MonoBehaviour
{
    ...
    private void CreateEdgeArray()
    {
        ...
        graph.CreateEdge(41, 41);
        graph.CreateEdge(42, 41);
        graph.CreateEdge(43, 41);
        graph.CreateEdge(44, 41);
        graph.CreateEdge(45, 41);
        graph.CreateEdge(46, 41);
        graph.CreateEdge(47, 41);
        graph.CreateEdge(48, 41);
        graph.CreateEdge(49, 41);
    }
}
