...
public class Player : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        UpdateWheelRotation(frontLeft, frontLeft.gameObject.transform);
        UpdateWheelRotation(frontRight, frontRight.gameObject.transform);
        UpdateWheelRotation(backLeft, backLeft.gameObject.transform);
